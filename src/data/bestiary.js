...
export const MILK_MOBS = [
  M({
    ...
    hp: 14, speed: 26, contact: 4, radius: 2.2, aa: 1,
  ...
  M({
    ...
    hp: 18, speed: 22, contact: 4, radius: 2.6, aa: 1,
    ability: 'dextrane',
  ...
  M({
    ...
    hp: 20, speed: 58, contact: 6, radius: 3, aa: 1,
    phSlow: 5.6,
  ...
  M({
    ...
    kind: 'rod', mot: 'swim', gram: '-',
    hp: 16, speed: 92, contact: 9, radius: 2.6, aa: 2,
  ...
  M({
    ...
    hp: 85, speed: 18, contact: 12, radius: 5.5, aa: 5, zSpeed: 0.16,
  ...
  M({
    ...
    hp: 120, speed: 0, contact: 8, radius: 7, aa: 6, zSpeed: 0.5,
    ability: 'hyphes',
  ...
  M({
    ...
    hp: 110, speed: 30, contact: 14, radius: 4.5, aa: 6,
    ability: 'sporulation',
  ...
  M({
    ...
    hp: 46, speed: 0, contact: 11, radius: 2.9, aa: 3, zSpeed: 0.4,
  ...
  M({
    ...
    hp: 10, speed: 14, contact: 3, radius: 2.5, aa: 2,
...
export const MILK_BOSSES = {
  staph: M({
    ...
    hp: 900, speed: 24, contact: 18, radius: 13, aa: 40, zSpeed: 0.3,
  ...
  listeria: M({
    ...
    hp: 2400, speed: 70, contact: 20, radius: 16, aa: 120, zSpeed: 0.4,
    boss: true, dropsPlasmid: true,
    phases: [
